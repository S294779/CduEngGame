$(function () {
    ...
    $.fn.answerFunction = function (options) {
        ...
        $('#answer-matrix .not-col-matched').off().on('click', function (e) {
            ...
            if(matchedCount >= options.numberOfQuestion){
            ...
            if (single_or_double == 1) {
                ...
                if (FK1 == SK1 && FK2 != SK2) {
                    ...
                    if (matchedCount <= options.numberOfQuestion) {
                        $('#firstQuestion').find('#popup-question').text(options.questions[matchedCount - 1].question);
                        $('#extra-question-id').val(options.questions[matchedCount - 1].id);
                        $('#firstQuestion').modal('show');
                        if(matchedCount == options.numberOfQuestion){
                            onlyoneOccur = matchedItemCollection;
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                                ...
                                $().answerFunction({
                                    ...
                                    numberOfQuestion:options.numberOfQuestion,
